...
class MemoryManager:
    ...
    def __init__(self):
        ...
        # Support ARDY_OFFLOAD environment variable
        self.offload_enabled = os.environ.get("ARDY_OFFLOAD", "0") == "1"
    ...
    def purge_model_completely(self, name: str):
        """Force-offload specified model."""
    ...
    def touch_and_move(self, name: str, device: str):
        ...
        if model is None:
            print(f"[MemoryManager] touch_and_move: model '{name}' not found. Registered: {list(self.models.keys())}")
            return
